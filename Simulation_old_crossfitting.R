...
simRep <- function(n = 250, p = 10)
{
  ...
  fit1=forest_balance(x,a,y,cross.fitting = FALSE)
...
#  dfxa1 <- data.frame(a = 1, x = x)
 ...
 # }
  ...
  est_vec <- c(unweighted = mean(y[a == 1]) - mean(y[a != 1]), 
               ...
               rf_mmd=fit1$ate,
               rf_mmd_cf=fit$ate,
               rf_IPW=weighted.mean(y[a==1],w=invprop[a==1])-weighted.mean(y[a==0],w=invprop[a==0]),
...
for (r in 1:nreps)
{
  ...
  {
    res_mat21 <- rbind(res_mat21, res_tmp)
  }
}
write.table(res_mat21,"resmat21",row.names = F,quote = F,col.names = TRUE)
...
for (r in 1:nreps)
{
  ...
  {
    res_mat22 <- rbind(res_mat22, res_tmp)
  }
}
write.table(res_mat22,"resmat22",row.names = F,quote = F,col.names = TRUE)
...
for (r in 1:nreps)
{
  ...
  {
    res_mat23 <- rbind(res_mat23, res_tmp)
  }
}
write.table(res_mat23,"resmat23",row.names = F,quote = F,col.names = TRUE)
...
for (r in 1:nreps)
{
  ...
  {
    res_mat24 <- rbind(res_mat24, res_tmp)
  }
}
write.table(res_mat24,"resmat24",row.names = F,quote = F,col.names = TRUE)
...
for (r in 1:nreps)
{
  ...
  {
    res_mat25 <- rbind(res_mat25, res_tmp)
  }
}
write.table(res_mat25,"resmat25",row.names = F,quote = F,col.names = TRUE)
...
for (r in 1:nreps)
{
  ...
  {
    res_mat26 <- rbind(res_mat26, res_tmp)
  }
}
write.table(res_mat26,"resmat26",row.names = F,quote = F,col.names = TRUE)
...
for (r in 1:nreps)
{
  ...
  {
    res_mat31 <- rbind(res_mat31, res_tmp)
  }
}
write.table(res_mat31,"resmat31",row.names = F,quote = F,col.names = TRUE)
...
for (r in 1:nreps)
{
  ...
  {
    res_mat32 <- rbind(res_mat32, res_tmp)
  }
}
write.table(res_mat32,"resmat32",row.names = F,quote = F,col.names = TRUE)
...
for (r in 1:nreps)
{
  ...
  {
    res_mat33 <- rbind(res_mat33, res_tmp)
  }
}
write.table(res_mat33,"resmat33",row.names = F,quote = F,col.names = TRUE)
...
for (r in 1:nreps)
{
  ...
  {
    res_mat34 <- rbind(res_mat34, res_tmp)
  }
}
write.table(res_mat34,"resmat34",row.names = F,quote = F,col.names = TRUE)
...
for (r in 1:nreps)
{
  ...
  {
    res_mat35 <- rbind(res_mat35, res_tmp)
  }
}
write.table(res_mat35,"resmat35",row.names = F,quote = F,col.names = TRUE)
...
for (r in 1:nreps)
{
  ...
  {
    res_mat36 <- rbind(res_mat36, res_tmp)
  }
}
write.table(res_mat36,"resmat36",row.names = F,quote = F,col.names = TRUE)
...
for (r in 1:nreps)
{
  ...
  {
    res_mat41 <- rbind(res_mat41, res_tmp)
  }
}
write.table(res_mat41,"resmat41",row.names = F,quote = F,col.names = TRUE)
...
for (r in 1:nreps)
{
  ...
  {
    res_mat42 <- rbind(res_mat42, res_tmp)
  }
}
write.table(res_mat42,"resmat42",row.names = F,quote = F,col.names = TRUE)
...
for (r in 1:nreps)
{
  ...
  {
    res_mat43 <- rbind(res_mat43, res_tmp)
  }
}
write.table(res_mat43,"resmat43",row.names = F,quote = F,col.names = TRUE)
...
for (r in 1:nreps)
{
  ...
  {
    res_mat44 <- rbind(res_mat44, res_tmp)
  }
}
write.table(res_mat44,"resmat44",row.names = F,quote = F,col.names = TRUE)
...
for (r in 1:nreps)
{
  ...
  {
    res_mat45 <- rbind(res_mat45, res_tmp)
  }
}
write.table(res_mat45,"resmat45",row.names = F,quote = F,col.names = TRUE)
...
for (r in 1:nreps)
{
  ...
  {
    res_mat46 <- rbind(res_mat46, res_tmp)
  }
}
...
colnames(res_mat)[7:8]=c("rf_mmd_cf3","rf_mmd_cf4")


res_mat=res_mat-1.884705
g1=res_mat %>% as.data.frame() %>%
  ...
  theme(axis.text.x = element_blank())+ggtitle("n=1000,p=10")



res_mat=read.table("resmat22",header=T)
res_mat=res_mat[,-1]
res_mat=cbind(res_mat,resmat2_f32,resmat2_f42)
colnames(res_mat)[7:8]=c("rf_mmd_cf3","rf_mmd_cf4")


res_mat=res_mat-1.884705
g2=res_mat %>% as.data.frame() %>%
  pivot_longer(cols = everything(),
               names_to = "Method",
               values_to = "Error") %>%
  ggplot(aes(x = Method, y = Error)) +
  geom_boxplot() + theme_bw(base_size = 18)+labs(x=NULL)+
  theme(axis.text.x = element_blank())+ggtitle("n=1000,p=100")


res_mat=read.table("resmat23",header=T)
res_mat=res_mat[,-1]
res_mat=cbind(res_mat,resmat2_f33,resmat2_f43)
colnames(res_mat)[7:8]=c("rf_mmd_cf3","rf_mmd_cf4")
...
g3=res_mat %>% as.data.frame() %>%
  ...
  ggplot(aes(x = Method, y = Error)) +
  geom_boxplot() + theme_bw(base_size = 18)+labs(x=NULL)+
  theme(axis.text.x = element_blank())+ggtitle("n=2000,p=10")

res_mat=read.table("resmat24",header=T)
res_mat=res_mat[,-1]
res_mat=cbind(res_mat,resmat2_f34,resmat2_f44)
colnames(res_mat)[7:8]=c("rf_mmd_cf3","rf_mmd_cf4")


res_mat=res_mat-1.884705
g4=res_mat %>% as.data.frame() %>%
  pivot_longer(cols = everything(),
               names_to = "Method",
               values_to = "Error") %>%
  ggplot(aes(x = Method, y = Error)) +
  geom_boxplot() + theme_bw(base_size = 18)+labs(x=NULL)+
  theme(axis.text.x = element_blank())+ggtitle("n=2000,p=100")

res_mat=read.table("resmat25",header=T)
res_mat=res_mat[,-1]
res_mat=cbind(res_mat,resmat2_f35,resmat2_f45)
colnames(res_mat)[7:8]=c("rf_mmd_cf3","rf_mmd_cf4")


res_mat=res_mat-1.884705
g5=res_mat %>% as.data.frame() %>%
  pivot_longer(cols = everything(),
               names_to = "Method",
               values_to = "Error") %>%
  ggplot(aes(x = Method, y = Error)) +
  geom_boxplot() + theme_bw(base_size = 18)+labs(x=NULL)+
  theme(axis.text.x = element_text(angle = 45, hjust=1) )+ggtitle("n=4000,p=10")

res_mat=read.table("resmat26",header=T)
res_mat=res_mat[,-1]
res_mat=cbind(res_mat,resmat2_f36,resmat2_f46)
colnames(res_mat)[7:8]=c("rf_mmd_cf3","rf_mmd_cf4")


res_mat=res_mat-1.884705
g6=res_mat %>% as.data.frame() %>%
  pivot_longer(cols = everything(),
               names_to = "Method",
               values_to = "Error") %>%
  ggplot(aes(x = Method, y = Error)) +
  geom_boxplot() + theme_bw(base_size = 18)+labs(x=NULL)+
  theme(axis.text.x = element_text(angle = 45, hjust=1) )+ggtitle("n=4000,p=100")
...
res_mat=read.table("resmat31",header=T)
res_mat=res_mat[,-1]
res_mat=cbind(res_mat,resmat3_f31,resmat3_f41)
colnames(res_mat)[7:8]=c("rf_mmd_cf3","rf_mmd_cf4")
...
res_mat=read.table("resmat32",header=T)
res_mat=res_mat[,-1]
res_mat=cbind(res_mat,resmat3_f32,resmat3_f42)
colnames(res_mat)[7:8]=c("rf_mmd_cf3","rf_mmd_cf4")
...
res_mat=read.table("resmat33",header=T)
res_mat=res_mat[,-1]
res_mat=cbind(res_mat,resmat3_f33,resmat3_f43)
colnames(res_mat)[7:8]=c("rf_mmd_cf3","rf_mmd_cf4")
...
res_mat=read.table("resmat34",header=T)
res_mat=res_mat[,-1]

res_mat=cbind(res_mat,resmat3_f34,resmat3_f44)
colnames(res_mat)[7:8]=c("rf_mmd_cf3","rf_mmd_cf4")
...
res_mat=read.table("resmat35",header=T)
res_mat=res_mat[,-1]

res_mat=cbind(res_mat,resmat3_f35,resmat3_f45)
colnames(res_mat)[7:8]=c("rf_mmd_cf3","rf_mmd_cf4")
...
res_mat=read.table("resmat36",header=T)
res_mat=res_mat[,-1]

res_mat=cbind(res_mat,resmat3_f36,resmat3_f46)
colnames(res_mat)[7:8]=c("rf_mmd_cf3","rf_mmd_cf4")
...
res_mat=read.table("resmat41",header=T)
res_mat=res_mat[,-1]
res_mat=cbind(res_mat,resmat4_f31,resmat4_f41)
colnames(res_mat)[7:8]=c("rf_mmd_cf3","rf_mmd_cf4")
...
g1=res_mat %>% as.data.frame() %>%
  ...
  ggplot(aes(x = Method, y = Error)) +
  geom_boxplot() + theme_bw(base_size = 18)+labs(x=NULL)+
  theme(axis.text.x = element_blank())+ggtitle("n=1000,p=30")



res_mat=read.table("resmat42",header=T)
res_mat=res_mat[,-1]
res_mat=cbind(res_mat,resmat4_f32,resmat4_f42)
colnames(res_mat)[7:8]=c("rf_mmd_cf3","rf_mmd_cf4")
...
res_mat=read.table("resmat43",header=T)
res_mat=res_mat[,-1]
res_mat=cbind(res_mat,resmat4_f33,resmat4_f43)
colnames(res_mat)[7:8]=c("rf_mmd_cf3","rf_mmd_cf4")
...
g3=res_mat %>% as.data.frame() %>%
  ...
  ggplot(aes(x = Method, y = Error)) +
  geom_boxplot() + theme_bw(base_size = 18)+labs(x=NULL)+
  theme(axis.text.x = element_blank())+ggtitle("n=2000,p=30")

res_mat=read.table("resmat44",header=T)
res_mat=res_mat[,-1]
res_mat=cbind(res_mat,resmat4_f34,resmat4_f44)
colnames(res_mat)[7:8]=c("rf_mmd_cf3","rf_mmd_cf4")
...
res_mat=read.table("resmat45",header=T)
res_mat=res_mat[,-1]
res_mat=cbind(res_mat,resmat4_f35,resmat4_f45)
colnames(res_mat)[7:8]=c("rf_mmd_cf3","rf_mmd_cf4")
...
g5=res_mat %>% as.data.frame() %>%
  ...
  ggplot(aes(x = Method, y = Error)) +
  geom_boxplot() + theme_bw(base_size = 18)+labs(x=NULL)+
  theme(axis.text.x = element_text(angle = 45, hjust=1) )+ggtitle("n=4000,p=30")

res_mat=read.table("resmat46",header=T)
res_mat=res_mat[,-1]
res_mat=cbind(res_mat,resmat4_f36,resmat4_f46)
colnames(res_mat)[7:8]=c("rf_mmd_cf3","rf_mmd_cf4")
